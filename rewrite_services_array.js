...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  content = content.slice(0, startIndex) + newServices + "\nexport function ServicesPage" + content.slice(endIndex + endStr.length - 28); // -28 to adjust for the end string properly
